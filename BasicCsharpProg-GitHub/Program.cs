...
// this file contains program copied from Github from a repo for Interview question on Csharp

namespace BasicCsharpProg_GitHub
{
    class Program
    {
        ...
        // Q.17: PLay around with the insert method in the string class
        internal static void StringMethodExplorer()
        {
            // Insert method
